...
class AutoAddIblockElementPropertyMinimumAnswersToIb1720221226150921340000 extends BitrixMigration
{
    /**
     * Run the migration.
     *
    ...
    public function up()
    {
        $fields = array (
  'ID' => 0,
  'NAME' => 'Минимальное количество ответов',
  'SORT' => 470,
  'CODE' => 'MINIMUM_ANSWERS',
  'MULTIPLE' => 'N',
  'IS_REQUIRED' => 'N',
  'ACTIVE' => 'Y',
  'USER_TYPE' => false,
  ...
  array (
    ...
    {
        $id = $this->getIblockPropIdByCode('MINIMUM_ANSWERS', 17);
