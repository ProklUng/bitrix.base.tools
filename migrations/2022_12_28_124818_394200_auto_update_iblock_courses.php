...
class AutoUpdateIblockCourses20221228124818394200 extends BitrixMigration
{
    /**
     * Run the migration.
     *
  ...
  'API_CODE' => 'Courses',
  'REST_ON' => 'N',
  'LIST_PAGE_URL' => '#SITE_DIR#/Courses/index.php?ID=#IBLOCK_ID#',
  'DETAIL_PAGE_URL' => '#SITE_DIR#/Courses/detail.php?ID=#ELEMENT_ID#',
  'CANONICAL_PAGE_URL' => '',
  'INDEX_ELEMENT' => 'Y',
  'IBLOCK_TYPE_ID' => 'Courses',
  'LID' => 
  array (
    0 => 's1',
  ),
  ...
  'SECTION_PAGE_URL' => '#SITE_DIR#/Courses/list.php?SECTION_ID=#SECTION_ID#',
  'INDEX_SECTION' => 'Y',
