...
class AutoAddIblockElementPropertyResultToIb1620230123160029189000 extends BitrixMigration
{
    /**
     * Run the migration.
     *
  ...
  array (
    ...
    {
        $id = $this->getIblockPropIdByCode('RESULT', 16);
