...
class AutoAddIblockElementPropertyIntervalToIb1720221226150921292000 extends BitrixMigration
{
    /**
     * Run the migration.
     *
  ...
  array (
    ...
    {
        $id = $this->getIblockPropIdByCode('INTERVAL', 17);
